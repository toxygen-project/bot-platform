...
class Tox:
    ...
    def tox_conference_delete(self, conference_number):
        result = Tox.libtoxcore.tox_conference_delete(self._tox_pointer, c_int(conference_number), None)
        return result

    def tox_conference_peer_get_name(self, conference_number, peernumber):
    ...
    def tox_conference_get_title(self, conference_number, title):
    ...
    def tox_conference_set_title(self, conference_number):
        buffer = create_string_buffer(TOX_MAX_NAME_LENGTH)
    ...
    def tox_callback_conference_message(self, callback):
    ...
    def tox_callback_conference_title(self, callback):
    ...
    def tox_callback_conference_peer_list_changed(self, callback,):

...
class ToxBotAppParameters:
    ...
    def __init__(self,
                 ...
                 group_service_factory=group_service_default_factory,
        ...
        self._group_service_factory = group_service_factory
    ...
    def get_group_service_factory(self):
        return self._group_service_factory

    group_service_factory = property(get_group_service_factory)
